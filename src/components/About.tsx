              ...
              <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
                ...
                >
                  <div className="relative group/img flex justify-center items-center">
                    ...
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-primary/30 via-primary/20 to-primary/30 rounded-2xl blur-2xl"
                      animate={{
                        scale: [1, 1.1, 1],
                        opacity: [0.5, 0.7, 0.5],
                      }}
                    ...
                    <motion.img
                      src={profileImage}
                      alt="Shuvo Kumar Das - AI Engineer & Software Developer"
                      className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-2xl object-cover border-2 border-primary/30 shadow-xl"
                      animate={{
                        y: [0, -10, 0],
                      }}
                      transition={{
                    ...
                    {highlights.map((highlight, index) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="flex items-center gap-2 p-3 rounded-lg bg-primary/5 border border-primary/10 hover:bg-primary/10 hover:border-primary/20 transition-all duration-300 group/badge"
                        >
                          <div className="p-1.5 bg-primary/10 rounded-md group-hover/badge:bg-primary/20 transition-colors">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3 mb-2">
                            <motion.div
                              className="p-2 bg-primary/10 rounded-lg group-hover/skill:bg-primary/20 transition-colors duration-300 relative overflow-hidden"
